...
public interface PartnerAPI {
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Partner address updated successfully; returns the resource identifier"),
        @ApiResponse(
                responseCode = "400",
                description =
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Partner name updated successfully; returns the resource identifier"),
        @ApiResponse(
                responseCode = "400",
                description =
                        "The request body is missing or contains malformed JSON, or a request parameter has an incompatible type"),
    ...
    @PreAuthorize("hasAuthority('partner:write') and @ownerAccess.isSelfOrAdmin(#id)")
    ResponseEntity<IdResponse> changePartnerName(
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Returns a page of partners matching the search criteria, with pagination metadata"),
        @ApiResponse(
                responseCode = "400",
                description =
                        "The request body is missing or contains malformed JSON, or a request parameter has an incompatible type"),
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Partner updated successfully; returns the resource identifier"),
        @ApiResponse(
                responseCode = "400",
                description =
                        "The request body is missing or contains malformed JSON, or a request parameter has an incompatible type"),
