...
public interface ZipCodeAPI {
    ...
    @Operation(
            summary = "Lookup ZIP code",
            description =
                    "Looks up address data for a zip code so clients can autofill address forms before registration. Create/update flows persist the submitted address as-is and never call this provider.")
    @ApiResponses({
