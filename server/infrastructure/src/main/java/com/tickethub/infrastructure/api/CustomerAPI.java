...
public interface CustomerAPI {
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Customer name updated successfully; returns the resource identifier"),
        @ApiResponse(
                responseCode = "400",
                description =
    ...
    ResponseEntity<IdResponse> changeCustomerName(
            @PathVariable("id") String id, @RequestBody ChangeCustomerNameRequest input);
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "201",
                description =
                        "Customer created successfully; returns its identifier and the resource URL in the Location header"),
        @ApiResponse(
                responseCode = "400",
                description =
                        "The request body is missing or contains malformed JSON, or a request parameter has an incompatible type"),
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Returns a page of customers matching the search criteria, with pagination metadata"),
        @ApiResponse(
                responseCode = "400",
                description =
                        "The request body is missing or contains malformed JSON, or a request parameter has an incompatible type"),
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Customer updated successfully; returns the resource identifier"),
        @ApiResponse(
                responseCode = "400",
                description =
                        "The request body is missing or contains malformed JSON, or a request parameter has an incompatible type"),
