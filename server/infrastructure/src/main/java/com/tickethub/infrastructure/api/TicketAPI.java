...
public interface TicketAPI {
    ...
    @Operation(summary = "Validate Ticket",
            description = "Validates a ticket QR code at the door: proves the signature was issued by this system, confirms the ticket is unused and belongs to the show being controlled, that the show is happening today, and checks ticket and spot in so the QR cannot be reused")
    @ApiResponses({
        ...
        @ApiResponse(responseCode = "404", description = "The ticket, spot or show was not found for the supplied identifiers"),
        @ApiResponse(responseCode = "422", description = "The signature is invalid, the ticket was already used, belongs to another show, or the show is outside the check-in date"),
