...
public class MercadoPagoConfiguration {
    ...
    public MercadoPagoClient mercadoPagoClient(
        ...
        if (isBlank(properties.getAccessToken())) {
            throw new IllegalStateException("Mercado Pago access token is blank: set MERCADOPAGO_ACCESS_TOKEN");
        }
    ...
    public PaymentGateway mercadoPagoPaymentGateway(
    ...
    public MercadoPagoWebhookVerifier mercadoPagoWebhookVerifier(final MercadoPagoProperties properties) {
        ...
        return new MercadoPagoWebhookVerifier(
                Optional.ofNullable(properties.getWebhookSecret()).orElse(""), properties.getWebhookTolerance());
    }

    @Bean
    @ConditionalOnBean({MercadoPagoWebhookVerifier.class, PaymentGateway.class, ConfirmPaymentUseCase.class})
    public MercadoPagoWebhookHandler mercadoPagoWebhookHandler(
