...
public interface AuditAPI {
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Returns a page of audit entries matching the filters, with pagination metadata"),
        @ApiResponse(
                responseCode = "400",
                description =
        ...
        @ApiResponse(
                responseCode = "403",
                description = "The authenticated principal lacks permission for this operation"),
