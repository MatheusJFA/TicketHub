...
public interface ShowAPI {
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Section added to the show successfully; returns the show identifier"),
        @ApiResponse(
                responseCode = "400",
                description =
    ...
    ResponseEntity<IdResponse> addSectionToShow(
            @PathVariable("id") String id, @RequestBody AddSectionToShowRequest input);
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Show description updated successfully; returns the resource identifier"),
        @ApiResponse(
                responseCode = "400",
                description =
                        "The request body is missing or contains malformed JSON, or a request parameter has an incompatible type"),
    ...
    @PreAuthorize("@showAccess.canWrite(#id)")
    ResponseEntity<IdResponse> changeShowDescription(
            @PathVariable("id") String id, @RequestBody ChangeShowDescriptionRequest input);
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Show name updated successfully; returns the resource identifier"),
        @ApiResponse(
                responseCode = "400",
                description =
                        "The request body is missing or contains malformed JSON, or a request parameter has an incompatible type"),
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "201",
                description =
                        "Show created successfully; returns its identifier and the resource URL in the Location header"),
        @ApiResponse(
                responseCode = "400",
                description =
                        "The request body is missing or contains malformed JSON, or a request parameter has an incompatible type"),
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Show published successfully; returns the resource identifier"),
        @ApiResponse(
                responseCode = "400",
                description =
                        "The request body is missing or contains malformed JSON, or a request parameter has an incompatible type"),
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Show and its nested resources published successfully; returns the resource identifier"),
        @ApiResponse(
                responseCode = "400",
                description =
                        "The request body is missing or contains malformed JSON, or a request parameter has an incompatible type"),
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Returns a page of shows matching the search criteria, with pagination metadata"),
        @ApiResponse(
                responseCode = "400",
                description =
                        "The request body is missing or contains malformed JSON, or a request parameter has an incompatible type"),
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Show unpublished successfully; returns the resource identifier"),
        @ApiResponse(
                responseCode = "400",
                description =
                        "The request body is missing or contains malformed JSON, or a request parameter has an incompatible type"),
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description =
                        "Show and its nested resources unpublished successfully; returns the resource identifier"),
        @ApiResponse(
                responseCode = "400",
                description =
                        "The request body is missing or contains malformed JSON, or a request parameter has an incompatible type"),
