...
class CachedResponseSerializationTest {
    ...
    void roundTripsPaginatedSpots() {
        final var page = new Pagination<>(0, 10, 1,
                List.of(new SpotListResponse("spot-1", "A1", true, true,
                        Instant.parse("2026-09-22T10:00:00Z"), Instant.parse("2026-09-22T10:00:00Z"),
                        null)));
