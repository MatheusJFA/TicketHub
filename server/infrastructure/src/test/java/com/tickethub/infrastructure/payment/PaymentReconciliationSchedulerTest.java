...
class PaymentReconciliationSchedulerTest {
    ...
    private record Fixture(PaymentReconciliationScheduler scheduler, ReconcileOrdersUseCase useCase,
            Cache spots) {
    }
    ...
    void givenSettledOrders_whenReconcile_thenClearsSpotsCache() {
        ...
        when(fixture.useCase().execute()).thenReturn(
                Either.right(ReconcileOrdersOutput.from(List.of("order-1"), List.of(), List.of())));
    ...
    void givenEmptyRun_whenReconcile_thenKeepsCache() {
        final var fixture = fixture();
        when(fixture.useCase().execute()).thenReturn(
                Either.right(ReconcileOrdersOutput.from(List.of(), List.of(), List.of())));
