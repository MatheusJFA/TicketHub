...
public class NameTest {
    ...
    @ParameterizedTest(
            name = "Given null, empty, blank or malformed name \"{0}\", when create, then throws DomainException")
    @NullAndEmptySource
    ...
    void givenAValidName_whenCreate_thenStoreValue() {
        assertEquals(
                "João da Silva",
                Name.create("João da Silva").getValue(),
    ...
    void givenANameWithHyphen_whenCreate_thenStoreValue() {
        assertEquals(
                "Jean-Pierre",
                Name.create("Jean-Pierre").getValue(),
    ...
    void givenANullName_whenCreate_thenThrowDomainException() {
        ...
        assertEquals(
                "Invalid name null", exception.getMessage(), () -> "Exception message should be \"Invalid name null\"");
    }
    ...
    void givenABlankName_whenCreate_thenThrowDomainException() {
        ...
        assertEquals(
                "Invalid name    ", exception.getMessage(), () -> "Exception message should be \"Invalid name    \"");
    }
    ...
    void givenANameBelowMinimumLength_whenCreate_thenThrowDomainException() {
        ...
        assertEquals("Invalid name A", exception.getMessage(), () -> "Exception message should be \"Invalid name A\"");
    }
    ...
    void givenAValidNameWithExtraSpaces_whenCreate_thenNormalizeName() {
        ...
        assertEquals("João da Silva", name.getValue(), () -> "Name with extra spaces should be normalized");
    }
