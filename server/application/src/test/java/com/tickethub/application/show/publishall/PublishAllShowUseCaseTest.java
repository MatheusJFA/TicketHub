...
@DisplayName("Publish all show use case")
public class PublishAllShowUseCaseTest extends UseCaseTest {
    ...
    @InjectMocks
    private DefaultPublishAllShowUseCase useCase;
    ...
    public void givenValidCommand_whenExecute_shouldPersistAndReturnId() {
        ...
        final var command = PublishAllShowCommand.with(entity.getId().getValue());
