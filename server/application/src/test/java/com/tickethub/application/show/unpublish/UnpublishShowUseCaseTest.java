...
@DisplayName("Unpublish show use case")
public class UnpublishShowUseCaseTest extends UseCaseTest {
    ...
    @InjectMocks
    private DefaultUnpublishShowUseCase useCase;
    ...
    public void givenValidCommand_whenExecute_shouldPersistAndReturnId() {
        ...
        final var command = UnpublishShowCommand.with(entity.getId().getValue());
