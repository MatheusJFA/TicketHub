...
@DisplayName("Publish section use case")
public class PublishSectionUseCaseTest extends UseCaseTest {
    private static final Money PRICE = Money.create(new BigDecimal("50.00"), Currency.getInstance("BRL"));

    @InjectMocks
    private DefaultPublishSectionUseCase useCase;
    ...
    public void givenValidCommand_whenExecute_shouldPersistAndReturnId() {
        ...
        final var command = PublishSectionCommand.with(entity.getId().getValue());
